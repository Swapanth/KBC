...
include "connect.php";
$sid = $_SESSION['pid'];
if (!isset($_SESSION['music_played3'])) {
    echo '<script>
					...
					<section class="card">
						...
						<div class="card-body">
							...
							if ($q < 4) {
								...
								$ques = mysqli_query($conn, "SELECT * FROM words3 where qid not in (select qid from responses3 where sid='$sid') AND level=2 ORDER BY RAND() LIMIT 1;");
