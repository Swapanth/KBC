	    ...
	    if(isset($_POST['signup']))
		 {
		   ...
		   $usr_chk=mysqli_query($conn, "SELECT * FROM users where pid='$mobile';"); 		
		   ...
		   {			   
		   $query="insert into users (pid, pin, player_name, place, status, points) values ('$mobile','0000','$player_name','$place',1,100)";
						...
						<form action="dashboard.php" method='post'>
							...
							<div class="form-group mb-3">
								<div class="input-group">
									...
									<input id="pin" name="pin" type="number" class="form-control form-control-lg" placeholder="4 Digit PIN" MAXLENGTH='4' value=''  style='color:transparent; text-shadow:0 0 2px rgba(0,0,0,0.5);' autocomplete="off" REQUIRED/>
									<span class="input-group-append">
										<span class="input-group-text">
